...
setwd(file.path("~", "Documents", "projects", "seneca_paper", "seneca_stylometry", 
                "3_analysis", "pca_bct_results", "pca_sen_hero_chunks"))
# if there is an error in the previous command, then "Session" > "Set Working Directory", "Choose Directory...", 
# "seneca_stylometry/3_analysis/pca_bct_results/pca_sen_hero_chunks"
...
# this directory contains the plays of Seneca the Younger but HO is split into two chunks
"../../../corpora/corpus_sen_hero_chunks/"
raw.corpus <- load.corpus(files = "all", 
                          corpus.dir = file.path("..", "..", "..", "corpora", "corpus_sen_hero_chunks"),
                          encoding = "UTF-8")
...
results_pca_4grams_cor = stylo(frequencies = freqs.4grams, 
                               ...
                               custom.graph.title = "Comparison of Seneca's plays (HO in two chunks)", # title of the plot
...
# It can be found in `seneca_stylometry/3_analysis/results/pca_bct_results/pca_sen_hero_chunks/stylo_config.txt`.
