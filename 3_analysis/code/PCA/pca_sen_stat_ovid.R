...
setwd(file.path("~", "Documents", "projects", "seneca_paper", "seneca_stylometry", 
                "3_analysis", "pca_bct_results", "pca_sen_luc_stat"))
# if there is an error in the previous command, then "Session" > "Set Working Directory", "Choose Directory...", 
# "seneca_stylometry/3_analysis/pca_bct_results/pca_sen_luc_stat"
...
results_pca_4grams_cor = stylo(frequencies = freqs.4grams, 
                               ...
                               custom.graph.title = "Seneca (plays) versus Lucan, and Statius", # title of the plot
...
# It can be found in `seneca_stylometry/3_analysis/results/pca_bct_results/pca_sen_luc_stat/stylo_config.txt`.
