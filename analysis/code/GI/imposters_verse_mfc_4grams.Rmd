...
We can see that Octavia is at the *42th row* and Hercules Oetaeus at the *40th row*.
...
imposters.octavia <- imposters(
  reference.set = data[-c(42), 1:1500],
  test = data[42, 1:1500],
  iterations = 100,
  distance = 'eder'
)
...
```
```{r}
print("Octavia (1-1500 MFCs 4-grams):")
print(imposters.octavia)
```

```{r}
print("Hercules Oetaeus (1-1500 MFCs 4-grams):")
